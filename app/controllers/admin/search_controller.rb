  ...
  class SearchController < AdminController
    def index
      ...
      if global_search.present?
        ...
        @registrations = ConRegistration.ransack(full_name_or_fur_name_or_tel_or_address_line1_or_address_line2_or_postcode_or_city_or_county_or_country_cont: global_search).result(distinct: true)
      else
        # Search by attribute
